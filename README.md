# TpOffline 模组（Minecraft 1.21.11）

传送到离线玩家的最后下线位置。本分支（`mc-1.21.11`）为 **Fabric** 平台。
...
| 平台 | Minecraft 版本 |
| --- | --- |
| Fabric | 1.21.11（Fabric Loader ≥ 0.16.0，Fabric API 任意版本） |
...
1. 安装 [Fabric Loader](https://fabricmc.net/use/installer/) 1.21.11
