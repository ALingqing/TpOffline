# TpOffline 模组（Minecraft 26.2）

传送到离线玩家的最后下线位置。本分支（`mc-26.2`）为 **Fabric** 平台。
...
| 平台 | Minecraft 版本 |
| --- | --- |
| Fabric | 26.2（Fabric Loader ≥ 0.19.0，Fabric API 任意版本） |
...
1. 安装 [Fabric Loader](https://fabricmc.net/use/installer/) 26.2
